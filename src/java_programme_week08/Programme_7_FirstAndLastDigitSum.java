 ...
 * Example input/output.sumFirstAndLastDigit(252); →should return 4,
 ...
 * sumFirstAndLastDigit(0); → should return 0, the first digit and the last digit is 0 since
 * we only have 1 digit, whichgives us 0 + 0 and the sum is 0.
 * sumFirstAndLastDigit(5); → should return 10,
 * the first digit and the last digit is 5 since we only have 1 digit,
 * which gives us 5 + 5 and sum is 10. sumFirstAndLastDigit(-10); → should return -1,
 * since the parameter is negative and needs to be positive.
...
public class Programme_7_FirstAndLastDigitSum {
    public static void main(String[] args) {
        ...
        int result = obj.sumFirstAndLastDigit(number);
