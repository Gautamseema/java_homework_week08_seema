...
/**
 * Write a java programme  with the name sumDigits that has one int parameter called number.
 ...
 * Hint: Use n % 10 to extract the least-significant digit. Use n = n / 10 to discard
 * the least-significant digit.
 * The method needs to be static.Create a class with the name DigitSumChallenge.
 */
